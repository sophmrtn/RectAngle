...
#Saving file names
loss_log_file = 'classification_loss_resnet_weighted01.csv'
saved_model_file = 'resnet_weighted01' #Name of saved moel 
...
loss_fn = torch.nn.BCEWithLogitsLoss(reduction='mean', pos_weight = torch.tensor(0.1))#, pos_weight = torch.tensor(0.25))
